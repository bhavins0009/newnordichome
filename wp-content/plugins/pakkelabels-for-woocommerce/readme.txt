...
Tags: GLS, Post, shipmondo, forsendelse, shipping, PostNord, Post Danmark, Pakkeshop, GLS, Bring, fragt, shipping, pakkelabels.dk, dao, DAO365, postdk, automated shipping, woocommerce, valgfrit afhentningssted, fragtmodul, pakkeshop­vælger, shipmondo
...
Shipmondo for WooCommerce - Handle shipping easy and cost efficient.
...
* Possibility to set the shipping price based on the carts total weight / price / number of items
...
You just need to create a free account at ​https://shipmondo.com​, in order to be able to use Shipmondos services.

(Danish installation guide: https://www.pakkelabels.dk/integration/woocommerce-fragtmodul )


*   Install and activate this plugin.
*   To set up your Shipmondo-account, go to settings and then API, where you can generate your freight module key.
*   Go to https://developers.google.com/maps/documentation/javascript/get-api-key and get a free Google Maps API key.
...
Follow this stepbystep guide to set up your integration shopintegration: https://www.pakkelabels.dk/integration/woocommerce/

Note! Requires at least WooCommerce 2.5.x.
...
= 2.1.1 =
* Fixed problem with missing pickup-point ID when using dropdown instead of modal
