        ...
        <div class="shipmondo_stores">
            ...
            <div>
	            <div class="shipmondo_dropdown_button">
		            <input disabled type="button" id="shipmondo_find_shop_btn_<?php echo $index; ?>" name="shipmondo_find_shop[<?php echo $index; ?>]" class="button alt shipmondo_select_button" value="<?php echo __('Find nearest pickup point', 'pakkelabels-for-woocommerce' ); ?>" data-shipping-type="<?php echo $shipping_method->method_id; ?>" data-selection-type="dropdown">
	            </div>
                <div class="shipmondo_pickup_point_selector_dropdown_container">
		            <div class="shipmondo_pickup_point_selector_dropdown shipmondo-hidden">
