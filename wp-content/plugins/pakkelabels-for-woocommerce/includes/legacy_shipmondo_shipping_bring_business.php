...
class Legacy_Shipmondo_Shipping_Bring_Business extends Legacy_Shipmondo_Shipping_Main
{

    public function __construct($instance_id = 0)
    {
        $this->id = 'legacy_shipmondo_shipping_Bring_business';
    ...
    function shipmondo_shipping_Bring_business_field_process() {
        ...
        if((isset($_POST['ship_to_different_address']) &&  ($_POST['shipping_company'] == '' || !isset($_POST['shipping_company']))) && ($choosen_shipping_method1 == "legacy_shipmondo_shipping_Bring_business" || $choosen_shipping_method2 == "legacy_shipmondo_shipping_Bring_business")){
        ...
        if((!isset($_POST['ship_to_different_address']) && ($_POST['billing_company'] == '' || !isset($_POST['billing_company']))) && ($choosen_shipping_method1 == "legacy_shipmondo_shipping_Bring_business" || $choosen_shipping_method2 == "legacy_shipmondo_shipping_Bring_business")){
            if ( version_compare( $woocommerce->version, '2.1', '<' ) ) {
    ...
    function shipmondo_shipping_Bring_business_show_below_shipping($rate){
        ...
        $choosen_shipping_method1 = preg_replace('/\d/', '', $woocommerce->session->chosen_shipping_methods[0] );
        $choosen_shipping_method2 = preg_replace('/\d/', '', $woocommerce->session->chosen_shipping_methods );
        if($choosen_shipping_method1 == "legacy_shipmondo_shipping_Bring_business" || $choosen_shipping_method2 == "legacy_shipmondo_shipping_Bring_business"){
            if($rate->method_id == 'legacy_shipmondo_shipping_Bring_business'){
    ...
    {
        $methods['legacy_shipmondo_shipping_Bring_business'] = 'Legacy_Shipmondo_Shipping_Bring_Business';
        return $methods;
    }
}


$shipmondo_Bring_Business_Legacy = new Legacy_Shipmondo_Shipping_Bring_Business();
$shipmondo_Bring_Business_Legacy->mainAddActions();
$shipmondo_Bring_Business_Legacy->addActions();
$shipmondo_Bring_Business_Legacy->addFilters();