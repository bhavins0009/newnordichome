 ...
 */
class Shipmondo_Shipping_PostNord_Private extends Shipmondo_Shipping_Main
{
    ...
    {
        $this->id                 = 'shipmondo_shipping_postnord_private';
        $this->instance_id        = absint($instance_id);
        $this->method_title       = __('PostNord Private', 'pakkelabels-for-woocommerce');
        $this->method_description = __('Adds the option to ship with the PostNord private in the checkout', 'pakkelabels-for-woocommerce');
        $this->supports = array(
            'shipping-zones',
            'instance-settings',
        );
    ...
    function shipmondo_shipping_checkout_update_order_meta_postnord_method_private($order_id)
    {
        ...
        if ($choosen_shipping_method1 == 'shipmondo_shipping_postnord_private' || $choosen_shipping_method2 == 'shipmondo_shipping_postnord_private') {
    ...
    {
        $methods['shipmondo_shipping_postnord_private'] = 'Shipmondo_Shipping_PostNord_Private';
        return $methods;
    }
}


$Shipmondo_PostNord_Private = new Shipmondo_Shipping_PostNord_Private();
$Shipmondo_PostNord_Private->mainAddAction();
$Shipmondo_PostNord_Private->addActions();
$Shipmondo_PostNord_Private->addFilters();