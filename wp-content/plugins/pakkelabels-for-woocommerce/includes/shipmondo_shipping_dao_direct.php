 ...
 */
class Shipmondo_Shipping_DAO_Direct extends Shipmondo_Shipping_Main
{
    ...
    {
        $this->id                 = 'shipmondo_shipping_dao_direct';
        $this->instance_id        = absint($instance_id);
        $this->method_title       = __('DAO Direct', 'pakkelabels-for-woocommerce');
        $this->method_description = __('Adds the option to ship with the DAO direct in the checkout', 'pakkelabels-for-woocommerce');
        $this->supports = array(
            'shipping-zones',
            'instance-settings',
        );
    ...
    function shipmondo_shipping_checkout_update_order_meta_dao_method_direct($order_id)
    {
        ...
        if ($choosen_shipping_method1 == 'shipmondo_shipping_dao_direct' || $choosen_shipping_method2 == 'shipmondo_shipping_dao_direct') {
    ...
    {
        $methods['shipmondo_shipping_dao_direct'] = 'Shipmondo_Shipping_DAO_Direct';
        return $methods;
    }
}


$Shipmondo_DAO_Direct = new Shipmondo_Shipping_DAO_Direct();
$Shipmondo_DAO_Direct->mainAddAction();
$Shipmondo_DAO_Direct->addActions();
$Shipmondo_DAO_Direct->addFilters();