...
/**
 * @class 		Shipmondo_Shipping_bring_Business_Legacy
 * @version		0.1.0
 * @author 		Shipmondo
 */
class legacy_shipmondo_shipping_bring_private extends Legacy_Shipmondo_Shipping_Main
{

    public function __construct($instance_id = 0)
    {
        $this->id = 'legacy_shipmondo_shipping_bring_private';
    ...
    function shipmondo_shipping_checkout_update_order_meta_bring_method_private($order_id)
    {
        ...
        if ($choosen_shipping_method1 == 'legacy_shipmondo_shipping_bring_private' || $choosen_shipping_method2 == 'legacy_shipmondo_shipping_bring_private') {
    ...
    {
        $methods['legacy_shipmondo_shipping_bring_private'] = 'legacy_shipmondo_shipping_bring_private';
        return $methods;
    }
}


$shipmondo_bring_Private_Legacy = new legacy_shipmondo_shipping_bring_private();
$shipmondo_bring_Private_Legacy->mainAddActions();
$shipmondo_bring_Private_Legacy->addActions();
$shipmondo_bring_Private_Legacy->addFilters();