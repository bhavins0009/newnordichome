		...
		var range_row_html =
			'<tr class="shipmondo_tr">' +
				'<td class="shipmondo_td_minimum">' +
					'<input class="shipmondo_input_minimum" type="text" placeholder="'+symbol+'" value="'+minimum+'" >' +
				'</td>' +
				...
				'<td class="shipmondo_td_maximum">' +
					'<input class="shipmondo_input_maximum" type="text" placeholder="'+symbol+'" value="'+maximum+'">' +
				'</td>' +
